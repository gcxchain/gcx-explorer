<template>
    <div class="container">
        ...
        <div class="row" v-show="!loading">
            <!--区块信息-->
            <div class="col-md-12">
                <div v-if="block_info&&global_params" class="panel panel-default">
    ...
    export default {
        ...
        methods: {
            ...
            onUpdate () {
                ...
                this.supply_info = ChainStore.getObject('2.1.0').toJS();
