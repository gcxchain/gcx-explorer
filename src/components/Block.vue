<template>
    <div class="container">
        ...
        <div class="panel panel-default" v-if="block" v-show="!loading">
            <div class="panel-heading">
                <span class="fa fa-chain"></span>&nbsp;{{$t('block.title')}}
                <!-- <a class="pull-right" target="_blank"
                   :href="'https://wallet.gcx.im/#/block/'+keywords">{{$t('block.more')}}</a> -->
            </div>
        ...
        <!--区块json-->
        <json v-if="block" :json="block" v-show="!loading"></json>
