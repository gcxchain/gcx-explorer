const locale = {
    ...
    about: {
        ...
        project_intro: '本项目是银河链（GCX）的浏览器，GCX基于Graphene底层进行开发，因此本项目也可支持所有基于Graphene的链，任何的项目可以无偿使用和任意修改，并且欢迎对此项目有兴趣的小伙伴来提交Pull Request，你的贡献将有可能获得GCX(银河股)作为奖励',
        github: '开源地址',
        about_company: '关于GCX',
        company_intro1: 'GCX（银河链有限公司）成立于2018年，是一家基于区块链技术的去中心化数据交易所，适用于各行各业的数据交换。',
        company_intro2: 'GCX数据交易所具有不缓存数据、保护个人隐私、数据版权保护、数据新鲜度高、打击造假以及可以设置匿名交易等特点。',
